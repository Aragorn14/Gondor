package com.scube.Gondor.Chat.views;
...
public class ChatAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = vi.inflate(R.layout.activity_chat_bubble, null);
        ...
        QBUser currentUser = DataHolder.getDataHolder().getSignInQbUser();
    ...
    private String getTimeText(QBChatMessage message) {
        return DateTimeUtils.millisToLongDHMS(message.getDateSent() * 1000);
    }
